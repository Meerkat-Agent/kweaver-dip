...
export default function TaskTable(props: any) {
      ...
      render: (text: string, record: any) => {
        ...
        return (
          <div
            ...
            onClick={() => onClickOpMenu(_.includes([1, 2], record?.status) ? 'view' : 'edit', record)}
          >
   ...
   * 判断数据为空或是没有搜索结果
   */
  const emptyOrNoResult =
    listProps.name || listProps.algorithm_type !== 'all' || listProps.status !== 'all' || listProps.config_id !== 'all';
