...
const onReduceData = (algorithm: any, algorithm_type: number) => {
  ...
  const reduceData = _.reduce(
    ...
    (pre: any, key: any, index: any) => {
      ...
      pre[reduceKey] = [
        ...(pre?.[reduceKey] || []),
        { ..._.omit(key, algorithm_type === 4 ? ['name'] : currentAlgorithmType) }
      ];
      return pre;
    },
    {}
