      ...
      <div className="dataSet-content-preview ad-w-100 ad-h-100" style={{ display: 'flex' }}>
        ...
        <div className="preview-content">
          ...
          <div style={{ height: 56, minHeight: 56, display: 'flex', justifyContent: 'space-between' }}>
            <div style={{ fontWeight: 600, fontSize: 24, color: 'rgba(0,0,0,0.85)' }}>
              {intl.get('dataSet.vertitleDes', { version: selectBar })}
            </div>
            {!isView && (
              <Format.Button
                style={{ display: disableEditor ? 'block' : 'none', color: ' #237ce8', border: '1px solid #237ce8' }}
                onClick={handleClick}
              >
