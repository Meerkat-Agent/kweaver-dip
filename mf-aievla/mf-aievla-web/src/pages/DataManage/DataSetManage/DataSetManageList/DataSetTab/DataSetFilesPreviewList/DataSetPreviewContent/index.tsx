  ...
  const renderPreviewContent = () => {
    ...
    if (_.isEmpty(filesPreviewListStatus.dataSource)) {
          ...
          <NoData
            ...
            desc={
              <>
                <div className="dataSet-files-preview-tip ad-w-100 ad-h-100">{intl.get('dataSet.parseFileFailed')}</div>
                <div
                  className="dataSet-files-preview-tip ad-w-100 ad-h-100 ad-ellipsis"
      ...
      if (filesPreviewListStatus.fileType === 'normal') {
        return (
          <>
            {tip && (
              <WarningTip
                text={intl.get('dataSet.previewNormalFileTip', { len: 50 })}
                close={true}
                onClose={onTipClose}
              />
            )}
      ...
      return (
        <div>
          {tip && (
            <WarningTip text={intl.get('dataSet.previewJsonFileTip', { len: 20 })} close={true} onClose={onTipClose} />
          )}
